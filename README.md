...
- `SPECS/MISSION.md` — why the project exists and its non-negotiables.
- `SPECS/TECH.md` — the technology stack and engineering standards.
- `SPECS/ROADMAP.md` — what's built next and the long-term vision.
- `frontend/` — the browser app (HTML, CSS, JavaScript).
